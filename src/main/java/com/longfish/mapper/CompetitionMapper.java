...
public interface CompetitionMapper {
     ...
     */
    List<Competition> list(Integer page,
                           Integer pageSize,
                           String copName,
                           Short type,
                           Short isFull,
     ...
     * @return 可以报名的比赛数目
     */
    @Select("select count(*) from competition where cop_status = 2 and participated < limitation")
    int avaiCount();
     ...
     * @return 查询到的用户
     */
    @Select("select * from signs where cop_id = #{copId} and username = #{username}")
     ...
     * @return 报名的比赛的List集合
     */
    List<Competition> getCopByUsername(String username);
